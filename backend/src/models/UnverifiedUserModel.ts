...
interface UnverifiedUserModel extends Model<IUnverifiedUser> {
...
export default model<IUnverifiedUser, UnverifiedUserModel>("UnverifiedUser", UnverifiedUserSchema)